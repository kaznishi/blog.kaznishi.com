...
現職と前職ではバックエンドエンジニアとしてAWSやGCPのサービスを使いながらGoでアプリケーションを書く仕事をメインにしています。  
前々職ではサーバーサイドエンジニア=>インフラエンジニアという感じで仕事していました。  
個人的にはインフラサイドのことも分かるアプリケーションエンジニアという立ち位置で広範囲な知識が要求される仕事がしたいと思っています。  
コードは書きたい。

サーバーサイドでの主な使用言語はGoです。前々職ではPHP,Scalaも使用していました。
...
2022/06 - Now メタバースプラットフォームにおけるUGCストアのAPI serverの開発
...
2018/11 - 2022/05 スマホ決済サービスのマイクロサービスの継続開発(ざっくりすぎる)
